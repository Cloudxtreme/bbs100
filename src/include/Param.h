...
#define KVPARAM_HAVE_TALKEDTO		param[KVPARAM_HAVE_N+7]
#define KVPARAM_HAVE_HOLD			param[KVPARAM_HAVE_N+8]
#define KVPARAM_HAVE_FOLLOWUP		param[KVPARAM_HAVE_N+9]
#define KVPARAM_HAVE_X_REPLY		param[KVPARAM_HAVE_N+10]
#define KVPARAM_HAVE_CALENDAR		param[KVPARAM_HAVE_N+11]
#define KVPARAM_HAVE_WORLDCLOCK		param[KVPARAM_HAVE_N+12]
#define KVPARAM_HAVE_CHATROOMS		param[KVPARAM_HAVE_N+13]
#define KVPARAM_HAVE_HOMEROOM		param[KVPARAM_HAVE_N+14]
#define KVPARAM_HAVE_MAILROOM		param[KVPARAM_HAVE_N+15]
