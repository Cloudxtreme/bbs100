...
#define KVPARAM_HAVE_HOMEROOM		param[KVPARAM_HAVE_N+15]
#define KVPARAM_HAVE_MAILROOM		param[KVPARAM_HAVE_N+16]
#define KVPARAM_HAVE_CATEGORY		param[KVPARAM_HAVE_N+17]
#define KVPARAM_HAVE_CYCLE_ROOMS	param[KVPARAM_HAVE_N+18]
#define KVPARAM_HAVE_WRAPPER_ALL	param[KVPARAM_HAVE_N+19]
#define KVPARAM_HAVE_BINALLOC		param[KVPARAM_HAVE_N+20]
#define KVPARAM_HAVE_MEMCACHE		param[KVPARAM_HAVE_N+21]
#define KVPARAM_HAVE_FILECACHE		param[KVPARAM_HAVE_N+22]
#define KVPARAM_HAVE_RESIDENT_INFO	param[KVPARAM_HAVE_N+23]
#define KVPARAM_HAVE_DISABLED_MSG	param[KVPARAM_HAVE_N+24]
#define NUM_PARAM					(KVPARAM_HAVE_N+25)
