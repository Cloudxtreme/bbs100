...
#define KVPARAM_HAVE_MEMCACHE		param[KVPARAM_HAVE_N+19]
#define KVPARAM_HAVE_FILECACHE		param[KVPARAM_HAVE_N+20]
#define KVPARAM_HAVE_DISABLED_MSG	param[KVPARAM_HAVE_N+21]
#define NUM_PARAM					(KVPARAM_HAVE_N+22)
...
#define PARAM_HAVE_MEMCACHE			BPARAM(HAVE_MEMCACHE)
