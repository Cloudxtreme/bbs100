...
#define KVPARAM_DATA_PORT			param[2]
...
#define KVPARAM_FEELINGSDIR			param[KVPARAM_DIR_N+4]
#define KVPARAM_ZONEINFODIR			param[KVPARAM_DIR_N+5]
#define KVPARAM_LANGUAGEDIR			param[KVPARAM_DIR_N+6]
...
#define KVPARAM_LOGIN_SCREEN		param[KVPARAM_SCREEN_N+3]
#define KVPARAM_LOGOUT_SCREEN		param[KVPARAM_SCREEN_N+4]
#define KVPARAM_NOLOGIN_SCREEN		param[KVPARAM_SCREEN_N+5]
#define KVPARAM_MOTD_SCREEN			param[KVPARAM_SCREEN_N+6]
#define KVPARAM_REBOOT_SCREEN		param[KVPARAM_SCREEN_N+7]
#define KVPARAM_SHUTDOWN_SCREEN		param[KVPARAM_SCREEN_N+8]
#define KVPARAM_CRASH_SCREEN		param[KVPARAM_SCREEN_N+9]
#define KVPARAM_BOSS_SCREEN			param[KVPARAM_SCREEN_N+10]

#define KVPARAM_HELP_N				28
#define KVPARAM_SEP4				param[KVPARAM_HELP_N]

#define KVPARAM_FIRST_LOGIN			param[KVPARAM_HELP_N+1]
#define KVPARAM_HELP_STD			param[KVPARAM_HELP_N+2]
#define KVPARAM_HELP_CONFIG			param[KVPARAM_HELP_N+3]
...
#define KVPARAM_DEFAULT_LANGUAGE	param[KVPARAM_FILE_N+10]

#define KVPARAM_LOG_N				45
...
#define KVPARAM_LOGROTATE			param[KVPARAM_LOG_N+3]
#define KVPARAM_ARCHIVEDIR			param[KVPARAM_LOG_N+4]
#define KVPARAM_ONCRASH				param[KVPARAM_LOG_N+5]
#define KVPARAM_CRASHDIR			param[KVPARAM_LOG_N+6]

#define KVPARAM_MAX_N				52
...
#define KVPARAM_IDLE_TIMEOUT		param[KVPARAM_MAX_N+10]
...
#define KVPARAM_HAVE_TALKEDTO		param[KVPARAM_HAVE_N+6]
#define KVPARAM_HAVE_HOLD			param[KVPARAM_HAVE_N+7]
#define KVPARAM_HAVE_FOLLOWUP		param[KVPARAM_HAVE_N+8]
#define KVPARAM_HAVE_X_REPLY		param[KVPARAM_HAVE_N+9]
#define KVPARAM_HAVE_CALENDAR		param[KVPARAM_HAVE_N+10]
#define KVPARAM_HAVE_WORLDCLOCK		param[KVPARAM_HAVE_N+11]
#define KVPARAM_HAVE_CHATROOMS		param[KVPARAM_HAVE_N+12]
#define KVPARAM_HAVE_HOMEROOM		param[KVPARAM_HAVE_N+13]
#define KVPARAM_HAVE_MAILROOM		param[KVPARAM_HAVE_N+14]
#define KVPARAM_HAVE_LANGUAGE		param[KVPARAM_HAVE_N+15]
#define KVPARAM_HAVE_CATEGORY		param[KVPARAM_HAVE_N+16]
#define KVPARAM_HAVE_CYCLE_ROOMS	param[KVPARAM_HAVE_N+17]
#define KVPARAM_HAVE_WRAPPER_ALL	param[KVPARAM_HAVE_N+18]
#define KVPARAM_HAVE_DISABLED_MSG	param[KVPARAM_HAVE_N+19]
#define NUM_PARAM					(KVPARAM_HAVE_N+20)
...
#define PARAM_DATA_PORT				SPARAM(DATA_PORT)
...
#define PARAM_HELP_STD				SPARAM(HELP_STD)
...
#define PARAM_HAVE_CYCLE_ROOMS		BPARAM(HAVE_CYCLE_ROOMS)
