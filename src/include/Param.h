...
#define KVPARAM_USERDIR				param[KVPARAM_DIR_N+6]
#define KVPARAM_ROOMDIR				param[KVPARAM_DIR_N+7]
...
#define KVPARAM_HAVE_CATEGORY		param[KVPARAM_HAVE_N+15]
#define KVPARAM_HAVE_CYCLE_ROOMS	param[KVPARAM_HAVE_N+16]
#define KVPARAM_HAVE_WRAPPER_ALL	param[KVPARAM_HAVE_N+17]
#define KVPARAM_HAVE_MEMCACHE		param[KVPARAM_HAVE_N+18]
#define KVPARAM_HAVE_FILECACHE		param[KVPARAM_HAVE_N+19]
